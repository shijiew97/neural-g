...
Net_NPMLE <- function(X=NULL, Y, param=0, dist=NULL, hidden_size=500,
                      num_it=NULL, p=1, gpu_ind=0, L=5, n_grid=100,
    ...
    Code_Netnpmle <- paste(system.file(package="NetNPMLE"), "G_NPMLE.py", sep="/")
    reticulate::source_python(Code_Netnpmle)

    fit <- G_NPMLE(y1, X1, hidden_size1, gpu_ind1, L1, n1, p1, n01,num_it1, lr1,
